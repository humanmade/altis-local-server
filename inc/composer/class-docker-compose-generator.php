		...
		return $this->apply_service_defaults( [
			's3' => [
				...
				'labels' => [
					...
					"traefik.http.routers.{$this->project_name}-s3-client.middlewares={$this->project_name}-s3-client-stripprefix,{$this->project_name}-s3-client-addprefix",
					"traefik.http.middlewares.{$this->project_name}-s3-client-stripprefix.stripprefix.prefixes=/uploads",
					"traefik.http.middlewares.{$this->project_name}-s3-client-addprefix.addprefix.prefix=/{$this->bucket_name}/uploads",
